...
3. TTS: “Hark is ready. I'll speak from here.” If streaming/conversation is off, remind: radio mode ends with over or okay hark send. If streaming is on: after wake, keep talking — no re-wake between turns.  
